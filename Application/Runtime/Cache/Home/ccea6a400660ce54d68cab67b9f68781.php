    ...
    <body>
         <div class="container-fluid"style="opacity: 1.0">
          <div class="jumbotron">
            <div class="container">
                 <div class="row">
                      <img class="col-xs-4 col-sm-2" src="/stocktradingsystem/Public/logo2.jpg">
             ...
             <div class="panel panel-primary col-md-offset-4 col-xs-12 col-md-4">
                ...
                <div class="panel-body">
                  <form class="form-horizontal" action="/stocktradingsystem/index.php/Home/Index/check_login" target='_self'id="loginForm" method="post" name="myForm" onSubmit="return checkForm();">
        ...
        <script src="/stocktradingsystem/Public/js/jquery-1.12.3.min.js"></script>
    <!-- Include all compiled plugins (below), or include individual files as needed -->
        <script src="/stocktradingsystem/Public/js/bootstrap.min.js"></script>
    </body>
</html>