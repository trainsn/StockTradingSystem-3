    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
     <?php if(($export) > "0"): ?><div class="table-responsive">    
       ...
       <thead><tr><th style="text-align: center;">证券名称(代码)</th>
           ...
           <th style="text-align: center;">成交状态</th>
           <th style="text-align: center;">操作</th>
        </tr>
       </thead>
       <tbody>
        <?php if(is_array($commission_info)): $i = 0; $__LIST__ = $commission_info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$commission_info): $mod = ($i % 2 );++$i;?><tr><td style="text-align: center;vertical-align: middle"><?php echo ($commission_info["stockname"]); ?>(<?php echo ($commission_info["stockid"]); ?>)</td>
              <td style="text-align: center;vertical-align: middle"><?php echo ($commission_info["direction_disp"]); ?></td>
              <td style="text-align: center;vertical-align: middle"><?php echo ($commission_info["commission_price"]); ?></td>
              <td style="text-align: center;vertical-align: middle"><?php echo ($commission_info["commission_account"]); ?></td>
              <td style="text-align: center;vertical-align: middle"><?php echo ($commission_info["time_disp"]); ?></td>
              <td style="text-align: center;vertical-align: middle"><?php echo ($commission_info["state_disp"]); ?></td>
              <td style="text-align: center;vertical-align: middle"><a href="/pro2/StockTradingSystem-3/index.php/Home/Index/doRevoke/commissionid/<?php echo ($commission_info["commissionid"]); ?>">撤销</a></td>
