...
">  
  ...
  <script>
   ...
   <div class="col-sm-8 col-xs-7">
    <form class="form-horizontal" action="/stocktradingsystem/index.php/Home/Index/addSell" method="post" name="myform" >
      ...
      <div class="form-group">
        <label class="col-sm-1 col-lg-2 control-label">卖出价格</label>
        <div class="col-sm-3 col-lg-3">
        <input type="text" class="form-control" name="commission_price">
      </div>
      </div>
      <div class="form-group">
        <label class="col-sm-1 col-lg-2 control-label">卖出数量</label>
        <div class="col-sm-3 col-lg-3">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-3 col-lg-3">
        <input type="text" class="form-control" name="commission_account" value="<?php echo ($bankroll_usable); ?>" readonly>
      </div>
      </div>
      <div class="form-group">
